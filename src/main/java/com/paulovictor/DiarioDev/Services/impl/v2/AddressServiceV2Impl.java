package com.paulovictor.DiarioDev.Services.impl.v2;

import com.paulovictor.DiarioDev.Services.v2.AddressServiceV2;
import com.paulovictor.DiarioDev.models.v2.AddressV2;
import com.paulovictor.DiarioDev.models.v2.UserV2;
import com.paulovictor.DiarioDev.repositories.v2.AddressRepositoryV2;
import com.paulovictor.DiarioDev.repositories.v2.UserRepositoryV2;
...
public class AddressServiceV2Impl implements AddressServiceV2 {
    ...
    public AddressV2 save(final AddressV2 address) {
        UserV2 userV2 = userRepositoryV2.findById(address.getUserV2().getUserId())
                .orElseThrow(() -> new EntityNotFoundException("User not found"));

        address.setUserV2(userV2);
    ...
    public AddressV2 update(final Long id, final AddressV2 address){
        ...
        UserV2 userV2 = userRepositoryV2.findById(address.getUserV2().getUserId()).orElseThrow(() -> new EntityNotFoundException("User not found"));
        ...
        addressUpdate.setUserV2(userV2);
